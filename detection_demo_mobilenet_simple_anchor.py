...
model_path = '/home/zhanjinhao/codes/车辆检测/ssdlite_mobilenet_v2/saved_model/mobilenet_v2_1.0_384_192_simple_cosine/last.pth'
...
net = create_mobilenetv2_ssd_lite(len(class_names), is_test=True,width_mult=1.0)
# net.load(model_path)
