...
from net.shufflenet_v2_ssdlite_w_h import create_shufflenetv2_ssd_lite
from data.voc_dataset import VOCDataset
from net.losses.multibox_loss import MultiboxLoss
from net.config import shufflenet_ssd_w_h_config
from data.data_preprocessing import TrainAugmentation_w_h, TestTransform_w_h

from tensorboardX import SummaryWriter
from eval import get_map_shufflenet
import datetime
...
def save_model(net, optimizer, best_mAP, save_best=False):
...
if __name__ == '__main__':
    ...
    create_net = lambda num: create_shufflenetv2_ssd_lite(num)
    config = shufflenet_ssd_w_h_config
    ...
    if args.freeze_base_net:  # backbone的权重不更新
        ...
        params = itertools.chain( net.extras.parameters(),
    ...
    for epoch in range(last_epoch, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs:
            ...
            map = get_map_shufflenet(net.state_dict(), args.validation_dataset, label_file)
            ...
            if map > best_mAP:
                ...
                save_best = False
            save_model(net, optimizer, best_mAP, save_best)
