...
#     sys.exit(0)
net_type = 'shufflenet'
model_path = '/home/zhanjinhao/codes/车辆检测/ssdlite_mobilenet_v2/saved_model/shufflenet_v2_full/last.pth'
...
net = create_shufflenetv2_ssd_lite(len(class_names)+1, is_test=True)
