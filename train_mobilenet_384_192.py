...
from net.mobilenet_v2_ssd_lite_w_h import create_mobilenetv2_ssd_lite
from data.voc_dataset import VOCDataset
from net.losses.multibox_loss import MultiboxLoss
from net.config import mobilenet_ssd_384_192_config
...
if __name__ == '__main__':
    ...
    config = mobilenet_ssd_384_192_config
