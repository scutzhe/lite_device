...
from net.head.shuffle_ssd_5b_224 import SSD
from net.predictor import Predictor_w_h,Predictor
# from net.config import shufflenet_ssd_config as config
from net.config import shufflenet_ssd_5b_224 as config
...
def create_shufflenetv2_ssd_lite(num_classes,is_test=False):
    # base_net = shufflenet_v2_x0_5(num_classes = num_classes).features
    ...
    regression_headers = ModuleList([
        # SeperableConv2d(in_channels=96, out_channels=6 * 4,kernel_size=3, padding=1, onnx_compatible=False),
...
if __name__ == '__main__':
    ...
    # print(net)
    torch.save({'net':net.state_dict()},'shufflenet_5b_224.pth')
