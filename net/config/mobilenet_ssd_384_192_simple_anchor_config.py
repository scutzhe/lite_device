...
sys.path.append("../..")
import numpy as np
from utils.box_utils import SSDSpec_w_h, SSDBoxSizes, generate_ssd_priors_w_h_simple
...
priors = generate_ssd_priors_w_h_simple(specs, image_width,image_height)