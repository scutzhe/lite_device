...
from net.backbone.mobilenet_v2_simple import MobileNetV2, InvertedResidual
from net.head.ssd import SSD, GraphPath
from net.predictor import Predictor_w_h
from net.config import mobilenet_ssd_384_192_simple_anchor_config as config
...
def create_mobilenetv2_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False):
    ...
    regression_headers = ModuleList([
        SeperableConv2d(in_channels=round(576 * width_mult), out_channels=2 * 4,
                        kernel_size=3, padding=1, onnx_compatible=False),
        SeperableConv2d(in_channels=1280, out_channels=2 * 4, kernel_size=3, padding=1, onnx_compatible=False),
    ...
    classification_headers = ModuleList([
        SeperableConv2d(in_channels=round(576 * width_mult), out_channels=2 * num_classes, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=1280, out_channels=2 * num_classes, kernel_size=3, padding=1),
...
if __name__ == '__main__':
    ...
    torch.save({'net':net.state_dict()},'mobilenet_v2_0125_ssdlite_384_192_simple.pth')
    # print(net)
