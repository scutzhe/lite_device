...
from net.config import mobilenet_ssd_384_192_config as config
...
if __name__ == '__main__':
    import cv2
    import time
    net = create_mobilenetv2_ssd_lite(2,0.125)
    torch.save({'net':net.state_dict()},'mobilenet_v2_0125_ssdlite_384_192.pth')
    # print(net)
